...
$content = preg_replace(
    '/<link rel="stylesheet" href="https:\/\/unpkg.com\/leaflet[^>]+>[\s]*<link rel="stylesheet" href="https:\/\/unpkg.com\/leaflet-routing-machine[^>]+>[\s]*<script src="https:\/\/unpkg.com\/leaflet[^>]+><\/script>[\s]*<script src="https:\/\/unpkg.com\/leaflet-routing-machine[^>]+><\/script>/s',
...
$content = str_replace(
    ...
    '.ol-zoom { display: none; } .leaflet-routing-container {',
    $content
);
...
<script>
        ...
        async function markPickedUp() {
            if (!confirm("Confirm order has been picked up from the restaurant?")) return;
        ...
        async function markDelivered() {
            if (!confirm("Confirm this order has been successfully delivered?")) return;
